 ...
 * @constructor
 */
OO.ui.ArchLinuxTheme = function OoUiWikimediaUITheme() {
	// Parent constructor
	OO.ui.ArchLinuxTheme.super.call( this );
};

/* Setup */

OO.inheritClass( OO.ui.ArchLinuxTheme, OO.ui.Theme );
 ...
 * @inheritdoc
 */
OO.ui.ArchLinuxTheme.prototype.getElementClasses = function ( element ) {
	var
		variants = {
			invert: false,
			progressive: false,
		...
		// Parent method
		classes = OO.ui.ArchLinuxTheme.super.prototype.getElementClasses.call( this, element );
 ...
 * @inheritdoc
 */
OO.ui.ArchLinuxTheme.prototype.getDialogTransitionDuration = function () {
	return 250;
};

/* Instantiation */

OO.ui.theme = new OO.ui.ArchLinuxTheme();

}( OO ) );

//# sourceMappingURL=oojs-ui-archlinux.js.map.json